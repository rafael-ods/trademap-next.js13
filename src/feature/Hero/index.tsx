    ...
    <section className="bg-gray-main pt-20">
      <div className={classMerge([
        ...
        <div className="md:col-span-6 flex flex-col gap-6">
          ...
          >
            <strong className="font-bold">Já são mais de 3 milhões
            </strong> de <br className="md:hidden" /> investidores que usam <br className="hidden md:hidden"/> o
            <strong className="font-bold pl-1">TradeMap</strong> para gerenciar todo investimento por um só lugar
          </p>
          <p
          data-aos="fade-up"
          data-aos-delay={600}
        ...
        >
          <img className="w-[328px] md:w-auto" src="/assets/hero/cel-trademap.png" alt="cell" />
          <img className="hidden absolute bottom-20 left-0 bg-white-main p-1 xl:block" src="/assets/hero/qr-code.png.png" alt="qr code" />
        </div>
      </div>
    </section>
  )
